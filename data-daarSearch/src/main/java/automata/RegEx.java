  ...
  public static void main(String arg[]) {
    ...
    if (regEx.length()<1) {
      ...
      try {
        ...
        System.out.println("  >> Building Automata.");
        System.out.println("  >> ...");
        Automata automata = Automata.fromRegExTree(ret);
        System.out.println("  >> Automata completed.");
        System.out.println("  >> ...");
        System.out.println(automata);
        System.out.println("  >> ...");
        System.out.println("  >> Cleaning Automata.");
        System.out.println("  >> ...");
        Automata automata2 = Automata.fromEpsilonAutomata(automata);
        System.out.println("  >> Automata Cleaned.");
        System.out.println("  >> ...");
